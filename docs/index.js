...
if(s.joinDate){const t=new Date(s.joinDate).getTime();clone.joinedAt=t};FluxDispatcher.dispatch({type:"USER_PROFILE_UPDATE",userProfile:clone})
}
let patches=[]
...
const[jd,setJd]=useState(s.joinDate||"")
...
h(FormInput,{title:"Fake Join Date",placeholder:"e.g. 2020-01-15",value:jd,onChange:function(v){setJd(v);s.joinDate=v;refreshUser();setTimeout(refreshProfile,100)}})),

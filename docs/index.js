...
const selfId=findByStoreName("UserStore")?.getCurrentUser()?.id
    UPS.getUserProfile=function(id){
      ...
      if(p&&s.enabled&&selfId&&id===selfId){
        ...
        c.premiumType=2;c.premiumFlags=3
